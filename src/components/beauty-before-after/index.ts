...
/* ---- inlined: components/beauty-before-after/styles.ts ---- */
...
/* ---- inlined: components/beauty-before-after/types.ts ---- */
...
/* ---- inlined: components/beauty-before-after/utils.ts ---- */
const BEFORE =
...
/* ---- inlined: components/beauty-before-after/index.ts ---- */
...
bindSallaRegistration(BeautyBeforeAfter as unknown as CustomElementConstructor & { registerSallaComponent?: (tagName: string) => void });
