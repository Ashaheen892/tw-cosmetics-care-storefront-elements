...
/* ---- inlined: components/beauty-care-assistant/styles.ts ---- */
...
/* ---- inlined: components/beauty-care-assistant/types.ts ---- */
interface TrailStep {
  questionKey: string;
  questionText: string;
  answerLabel: string;
...
type AssistantStyle = 'chat' | 'expert' | 'mirror' | 'cards';

/* ---- inlined: components/beauty-care-assistant/utils.ts ---- */
...
function resolveStyle(config: Record<string, unknown>): AssistantStyle {
...
function currentDepth(trail: TrailStep[], hasResult: boolean): number {
