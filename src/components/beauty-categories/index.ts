...
/* ---- inlined: components/beauty-categories/styles.ts ---- */
...
/* ---- inlined: components/beauty-categories/types.ts ---- */
...
/* ---- inlined: components/beauty-categories/utils.ts ---- */
...
function parseItems(raw: unknown): CategoryItem[] {
...
function resolveLayout(raw: unknown): 'slider' | 'grid' {
