import { LitElement, css, html, nothing, unsafeCSS, type CSSResult } from 'lit';
...
/* ---- inlined: components/beauty-promo-banners/styles.ts ---- */
...
/* ---- inlined: components/beauty-promo-banners/types.ts ---- */
...
/* ---- inlined: components/beauty-promo-banners/utils.ts ---- */
...
function parseBanners(raw: unknown): PromoBanner[] {
...
/* ---- inlined: components/beauty-promo-banners/index.ts ---- */
...
bindSallaRegistration(BeautyPromoBanners as unknown as CustomElementConstructor & { registerSallaComponent?: (tagName: string) => void });
